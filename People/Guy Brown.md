...
- [[University of Sheffield]]. Referenced re: value of [[AI]] across [[University of Sheffield|UoS]] (Halifax connection) and co-prepared a CMI slide for a presentation - see [[2024-01-25 Presentation Prep]]. Also intro'd the Responsible [[AI]] Workshop alongside Kirsty McNeil - see [[2023-12-04 Responsible AI Workshop]] (that occurrence used "Guy B" - same inference, not separately confirmed, flag if wrong).
