...
- **The North: Impacts of [[AI]] and Digital on Skills, Jobs, and Productivity**: [[Charlie Bartle]] (Zygenz) on the transformative effects of [[AI]]/digital on regional productivity. Zygenz's mission - [[AI]] consultancy, helping organisations implement [[LLM|LLMs]] and agents within service industries, specifically Law and HR. [[AI]] Labs - a hands-on training programme for [[LLM|LLMs]] and agents, with successful sessions recently held in Leeds. "Lovable" - an [[LLM]]-based tool that converts text prompts directly into functional apps.
