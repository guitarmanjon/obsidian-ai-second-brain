...
- Review progress on the DCM project, including plans, work package reports, and case studies.

## Key Discussion Points

- [[MM]] intends to have up-to-date plans for all his projects sorted and uploaded to Harbour by Christmas.
- [[JS]] - risk register etc. does not need transferring line by line; use the document feature instead.
...
- Use the document feature rather than transferring the risk register line by line.
- WP2.3 report deadline moved to end of November (no impact on project delivery).
