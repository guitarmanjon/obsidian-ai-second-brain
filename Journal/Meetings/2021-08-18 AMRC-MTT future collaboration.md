...
- Pre-meeting notes on future opportunities at AMRC:
  ...
  - Non-geometric validation - using machining data to validate parts, process and [[Machine Health Monitoring|machine health]]; open question of how to validate the data that is itself validating the parts.
...
- Meeting notes:
  ...
  - [[Chao Sun|Chao]]: use data to train [[Machine Learning|ML]] models, then only keep the [[Machine Learning|ML]] models, not the raw data.
