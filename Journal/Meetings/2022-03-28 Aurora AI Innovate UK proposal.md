...
- Market offering / competitors:
  - Machine Metrics and Marposs mentioned as competitors - two in US/Canada (one asset-based only targeting Fortune 500 companies with anomaly detection), one in Germany with a process focus.
  - Aurora positioned as the lowest cost offering.
  - Possible servitised model for Aurora.
- How AMRC could fit in: open comms protocols, industry contacts, use of AMRC facilities, data science collaboration, and a consultancy role in the project.
- Smart Grant deadline noted as 13th April.
