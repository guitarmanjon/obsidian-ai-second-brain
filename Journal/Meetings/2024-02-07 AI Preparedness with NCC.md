...
- Centres' input is proposed to be mainly an inward-facing view of how prepared the centre is for [[AI]] adoption, with some light-touch understanding of industry's status in the same space.
- Opportunity to engage local academic or industrial bodies with small (~£5k) inputs to produce short reports on regional [[AI]] readiness; NCC has already begun this engagement for the south west, and is seeking guidance on who to engage from AMRC's region for as broad a picture as possible.
- Circa £20-30k available to support this part of the project.
