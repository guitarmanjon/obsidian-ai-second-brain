...
- 10:24 - [[Geraint Prisk]] to give an overview of what's been done in the past, pre-COVID etc.

## Decisions

- Use a generic, internet-sourced CAD model of an engine for visualisations, to avoid export control issues.
- Target maturity horizon of 5 years for the next-generation factory concept, given the ~10-year product launch timeline.

## Action Items

- [[Geraint Prisk]] - (Give an overview of past pre-COVID Factory of the Future work)
