...
- 5 day visit:
  - Review these applications to see model suitability
  - DATA STRATEGY: labels, data structures, permissions
  - Data ownership -> contracts?
  - Data storage locations
- Fast Truss - AMRC project
- Experience in optimisation already -> auto generate configuration settings
- AMRC manufacturing experience is key to identifying key data opportunities
