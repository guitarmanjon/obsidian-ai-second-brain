...
- [[Donka]] raised the need to quantify Net Zero position from a component perspective: what toolsets exist for net zero/sustainability, and how to measure it in a standardised, common way; also how to reduce carbon footprint and improve process.

## Decisions

- Agreed to go forward with the uplift, with a Net Zero/sustainability focus.

## Action Items

- [[JS]] - Ask [[Andy Bell]] what the Small World report means for AMRC.
