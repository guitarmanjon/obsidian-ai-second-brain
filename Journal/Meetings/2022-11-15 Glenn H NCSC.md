...
- Introductory call with Glenn H of NCSC to discuss a proposed Critical National Infrastructure (CNI) OT cybersecurity lab and AMRC's potential involvement.

## Key Discussion Points

- [[Glenn H]] is tech lead for OT, sitting in the CTO team at the Critical National Infrastructure team; very little OT expertise in-house, hence the call with AMRC.
- Proposal for a CNI lab for OT, akin to Idaho National Labs - possibly like a NATO Cyber range.
- Government funding to set up the lab; [[Glenn H]] will be tech lead for the CNI Lab, focused on improving OT cybersecurity, building on existing investment.
- Connection issues affected parts of the call.
...
- [[Glenn H]] - (Follow up on CNI Lab plans and potential AMRC involvement)
