...
- AMRC-side options:
  - Bridgeport - possibly with a dummy sensor; Colchester preferred since it can actually be run.
  - HVAC and similar equipment.
  - Site visit planned to look at potential assets - pumps, HVAC, etc., ideally located close together (e.g. plant room on mezzanine).
