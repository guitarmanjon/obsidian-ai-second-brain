...
- Plan to review the map of faults to be detected (from an [[Rolls-Royce|R-R]] exercise ~12 months ago) and assess which can be captured/detected/prevented using production-ready tools, including reasoning trees within each factory for fault finding based on [[MES]] data (SAP reason trees).
