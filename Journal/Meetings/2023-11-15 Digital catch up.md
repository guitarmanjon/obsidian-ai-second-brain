...
- Siemens: Insights Hub has been purchased, along with 2 licenses for Industrial Edge devices. Potential delay from Siemens because Luke is currently out of action.
  ...
  - Raised questions: why are licenses activated when hardware is delivered rather than when it's ready to use? AMRC policy is not to pay for things that haven't been delivered/installed/checked. Edge and Insights Hub are on the same PO. How long will new hardware take? Could an old IPC be used with a new license instead?
  - Suggestion that the Tuesday session be used for a chat with [[Sabino]] around Factory of the Future (FoF) challenges.
  - Review of BFC deployment in FoF.
- Next year's Catapult: DCM continuation; [[Rab]] to include this in the central Digital proposal.
