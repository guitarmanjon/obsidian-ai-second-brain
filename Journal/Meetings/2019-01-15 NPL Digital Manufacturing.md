...
- NPL DESC/Digital Manufacturing - [[Gareth Edwards]]
	...
	- Data science now part of the UK national measurement strategy - team of 30 at NPL, growing.
	- Quantum technology; Digitally Enabled Supply Chain (DESC).
...
- [[David Butler]] - DESC
	...
	- How do process variations affect the downstream supply chain? Idea of embracing variation rather than driving it out.
- Rab: quick demo of trust in data using Excel - formatting of cells changes the result; Excel is built on a 15 d.p. back end - are people aware of this?
- AMRC opportunities:
	- Tom H: Wing of Tomorrow - metrology throughout all elements of the wing; trust in data; how do you get verification "for free" (Ben)?
	- Rab: 2018-2023 HVM Catapult delivery plan has 12 key challenges.
	- Jon S: non-geometric validation - using sensor data to give confidence and remove most of the end-of-process geometric measurement; NPL could inform on the traceability aspect.
	- Rab: power monitoring of machine tools to understand condition (linked to the Austin Consultants work, name not mentioned) - NPL have experience/expertise in power signals and cleanliness, and interrogation of signals.
- Discussion: expectations/outcome from a demonstrator; brainstorming.
