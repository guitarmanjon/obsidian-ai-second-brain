...
- Key challenges highlighted for assembly, disassembly and test in the future:
  - Deliver increased new production assembly capacity - return to service of airlines post-COVID has been faster than expected, and isn't expected to slow down.
  - Expansion in MRO capacity globally - e.g. the BAESC facility in Beijing for MRO.
  - New future product & architecture (UltraFan).
