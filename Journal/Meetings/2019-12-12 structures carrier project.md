...
The source text interleaves meeting notes with the text of an email from [[dan smith]] circulating a project proposal. Reconstructed below.

**Meeting notes**
- See [[dan smith]]'s email of 21st November for details of the project proposal.
...
- Following the recent Catapult 2020 funding bid, an unconfirmed amount has been won, some of which will go towards technology carriers such as the one [[dan smith]] proposed.
- Requested a time for an initial discussion (90 min slot) on how to drive this forward, via a Doodle poll.
- Wanted to discuss "Year 1" of the original submission in particular; each recipient would play a pivotal role in delivering the project.
- Wanted to keep the attendee list minimal for now while discussing options for next year's work, aiming for a draft SoW and plan by year end.

**Project proposal detail: "Aerostructures, a Light Weighting Strategy"** (pasted into the email, referenced above)
- Builds on the AI4125P project (AMRC's readiness to support light-weighting/electrification), which reviewed optimised pocket geometry and manufacturing methods for "thin walled" aerostructures.
- Rationale: more disruptive light-weighting approaches will be needed as aircraft batteries are added; medium-sized aircraft are expected to be among the first to push toward electrification, meaning power requirements (and the timeline) may be shorter than expected.
...
- [[dan smith]] - (Provide a top-level overview of what each team will contribute and resource requirements)
