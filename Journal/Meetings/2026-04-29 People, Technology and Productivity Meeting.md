...
- **Internal AMRC action items/ideas noted by JS**: organise an all-staff IMG "Hack Day" focused on practical applications of LLMs; launch a monthly AI update session for AMRC members; explore getting involved with the Sheffield Digital mentoring scheme.
