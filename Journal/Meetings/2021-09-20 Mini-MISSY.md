...
- Follow-on call with [[Andy Bell]]:
  ...
  - Intelligent loading of machine tools - only doing work when needed, potentially balancing machine running time so solar power can be used.
  - Mapping available data to the sustainability agenda - once data is available, review with [[Andy Bell]] to see what can be done.
