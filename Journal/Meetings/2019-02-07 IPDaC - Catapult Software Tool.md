...
- Overview of the software tool for catapult reporting - brings together technologies (Flask etc.) into a data-driven website.
- Discussion of what the "product" actually is - possibly a combination of: data capture from machines/sensors, database design, database querying, scripts that summarise the data, and the reporting webpage itself.
