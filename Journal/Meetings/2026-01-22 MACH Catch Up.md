...
- Recurring catch-up to work through outstanding logistics and prep items for the MACH conference.

## Key Discussion Points

- Coffee cups being considered for sign posting.
- A drop-in session with [[Chris Dungey]] is being considered for Wednesday or Thursday.
- Mixed messages have been heard about the speaker slot.
...
- [[Tom H]] - (Give permission for taking the coffee machine)
- [[Gemma Cowley|Gemma]] - (Clarify requirements for taking the coffee machine)
- [[JS]] - (Talk to [[AMRC North West]] first about the engine demo logistics, before [[Gual]] talks to them directly)
- [[JS]] - (Talk to [[Chris Dungey]] next week in the planned call about the speaking slot)
