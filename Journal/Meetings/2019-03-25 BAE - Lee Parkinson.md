...
- [[Lee Parkinson]] reached out (via email, forwarded by Austin Cook) to discuss using the Montronix system on Typhoon drilling machines for grip length measurement.
...
- [[JS]] - (Respond to [[Lee Parkinson]] with thoughts on timescales for investigating and trialling the Montronix-based grip length measurement process).
