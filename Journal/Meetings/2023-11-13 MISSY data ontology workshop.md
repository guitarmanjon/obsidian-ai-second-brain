...
- [[Neil Tatman]] (NT) wanted to catch up on MISSY and find out more about DoE (question raised over whether this was the right session for DoE). He has been developing a document defining what R-R would like to see from AxRCs, including use cases such as predictive maintenance. NT is concerned that MISSY isn't looking at these use cases, and asked whether schemas exist for the DoEs, KPIs, and sensor definition lists.
- [[JS]] asked whether the discussion could continue without an answer to NT's question; [[Jonathan Butters]] confirmed yes, the plan is to translate the Excel data dictionary contents into a conceptual map.
- Ontologies discussion: ISO 15926 proposed as a possible starting point.
