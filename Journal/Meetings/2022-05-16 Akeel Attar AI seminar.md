...
- [[Dimitrios Anagnostakis]] (asked questions in chat)
...
- Decision trees incorporate domain knowledge that allows insight into failure causes, enabling early prevention when an indicator is seen.
- Control systems need a gradient to determine next steps - symbolic learning models excel at this; fuzzy control is used in consumer systems.
- Real data is often sensitised to running within given bounds - ideally training data should exercise the full range of possible data, but this is often impractical as it could produce waste or breakdowns.
- Machine learning from experts - using subject matter expert examples to develop decision trees.
