...
- [[Tim Rooker]]
- [[Tom Finkill]]
- [[Rachel Yeung]] (unable to attend, sent context beforehand)
...
- TRL6: what's the impact of milling and drilling on this? Not needed to pass TRL6, but including it would require thoroughly proving out milling and drilling.
- Trials for each stage: discussion on how to make the Kistler system redundant, since it's tricky to move into production; Sandvik Silent Tools raised as a potential future commercial solution (sampling currently throttled but should be openable).

## Decisions

- Milling and drilling are not required to pass TRL6; including them would require substantial additional proving-out work.
