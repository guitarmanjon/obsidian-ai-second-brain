...
**What's Next?**
- Discussion of potential collaboration (45 min planned), focused on:
  - Where are the synergies and biggest benefit of working together on data-centric engineering within manufacturing?
  - Where can the biggest collaborative impact be achieved, and how?
  - What activities need to be piloted over the next 12-18 months?

Note: the source captured only the agenda for this visit; the remaining pages (198-207) contained no further notes, so outcomes of the discussion were not recorded.
