...
- Capture key takeaways from summit sessions on advanced analytics, data-driven decisions, and [[AI]]/[[Machine Learning|ML]], and note people worth connecting with afterwards.
...
- Use cases for [[Machine Learning|ML]]/[[AI]] often lie at the intersection between business units (e.g. plant and supply chain) where non-obvious relationships are revealed by [[AI]]/[[Machine Learning|ML]], and in removing low-value decision-making from people as a side-product.
...
- Distinction drawn between analytics (statistical indicators), [[Machine Learning|ML]] (a collaboration between data scientist and subject matter expert to build a model), and [[AI]] (deciding for itself what to do with data).
...
- [[AI]] & [[Machine Learning|ML]]: justification for use must be clear; complexity of the use case (beyond human capability to comprehend, e.g. multivariate analysis) determines the need for [[AI]]/[[Machine Learning|ML]].
