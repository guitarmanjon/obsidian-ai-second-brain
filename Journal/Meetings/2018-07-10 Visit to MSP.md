...
- Integrate into OMI/MHV at Rolls-Royce: RR CDS now using NC-Checker; MSP on RR's approved products list; MHV resistance based on existing Duttonmatic cycles, limited to Siemens controllers (management joined between Washington and Sunderland sites; Sunderland has more than Siemens controllers).
