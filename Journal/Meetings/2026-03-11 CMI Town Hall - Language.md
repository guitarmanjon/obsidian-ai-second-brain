...
- **JM update**
  - [[University of Sheffield|UoS]] Player.
...
- **[[Nikos Aletras]] - Teaching Machines to Learn Like Humans**
  - "The quest for data-efficient [[AI]]" — [[LLM|LLMs]] described as "Idiot Savants".
...
- **[[Carolina Scarton]] - [[LLM|LLMs]] in Language processing tasks (good, bad + ugly)**
  ...
  - Experimental work on disinformation found [[LLM|LLMs]] are good at creating disinformation.
...
- **[[Christos Christodoulopoulos]] - The Language of Responsible [[AI]]**
  ...
  - [[LLM|LLMs]] are just conditional probability / statistical language models - the question is how to control this probability.
