...
- [[Erdem Ozturk|Erdem]] asked about using their own apps on the Edge device.
  - [[Soeren Stelzer]]: an app must be published to be installed on Edge; training is available for how to do this.
  - [[Erdem Ozturk|Erdem]] wants to get more than one person onto training - needs to be the right people, not just anyone.
- [[Pete]] - OWA challenge:
