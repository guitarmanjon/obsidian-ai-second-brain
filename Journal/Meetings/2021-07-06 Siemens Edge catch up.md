...
- Mindsphere - license until April 2022 (per Kallum Slack message). Needed for "Operations Insight", which uses Industrial Edge data.
- Brownfield Connector - to be looked at once SINUMERIK and Industrial Edge are sorted.
- Omative - can probably get a 6 month trial. Need to identify a target person/use case in AMRC that wants to use it - complex machining processes, looking at machines already connected up.
- [[Rolls-Royce|R-R]] project - Teamcentre could be an option for data sharing across sites.
