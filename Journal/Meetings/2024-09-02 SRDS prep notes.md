...
- Review of the last year:
	- Theme: team seem happy, flexibility being allowed (working hours, projects). Staff development progressive - [[Jon]] and [[Alex]] both got promotion through ACP last year; ACP applications from [[Narcisa]], [[Lindsay]] and [[Tim]] in 2025, plus an AI-related role change for [[Tim]] this year. All G7 and above in the team, with a G6 PE coming in later this year.
	- Project work: [[HySaaS]] (£200k) going well, tech leadership from [[Tim]]; KTP with Boeing (£600k+) - bringing in [[Alex]] and [[Adam]] as supervisors was the right call; MUSIC - AVGI and MISSY involvement, [[Tim]] instrumental in MISSY; Catapult - strong portfolio this year, particularly DCM and Factory+; Cyber needs more work to secure funding, [[Grace]] to split time 50-50 with other projects (data science, AVGI?).
