...
- Case study - North Sea drilling: raised the question of how to decide on tree order (e.g. why RPM sits below mud temperature, and what reversing that would mean) - driven by expert knowledge; interactive symbolic learning combines [[Machine Learning|ML]] to determine an initial table with expert input to adjust it, testing the impact of adjustments, with data informing on that impact.
