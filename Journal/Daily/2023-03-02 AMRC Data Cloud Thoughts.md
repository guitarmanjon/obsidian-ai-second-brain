...
- Thinking through open governance questions for the AMRC Data Cloud.

### What would make today high-impact?

- Open questions: who decides what can/can't go into Data Cloud; proposed staging-area flow (raw format backup → cleaned/formatted → long-term storage).
...
- Noted this work sits naturally with IMG's data scientists — questioned why there isn't Catapult/other financial support for it.
