...
- Testbed spans I2.0/I3.0/I4.0 connectivity, from a handful of sensors up to ~100 plus high-rate [[CNC]] data; supports [[AI]]/[[Machine Learning|ML]] model testing, dashboarding, sensor fusion, and legacy cybersecurity testing.
- **Cyber Security:** builds on AMRC's [[HVMC]]-published Cyber Security Risk Assessment for Advanced Manufacturing; offers company risk assessments, use of the ICEOTOPE PetaGen Micro Modular Data Centre for network monitoring, a low-risk environment to test cyber threat detection against OT systems (PLCs, robot controls), and support preparing for audits like IEC62443.
