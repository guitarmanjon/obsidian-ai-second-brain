...
- Component located on the shop floor; originally machined on a 3-axis machine (X, Y, Z) requiring 3 separate setups (7hr machining time + 7hr setting up for fixturing/[[Probing|probing]]).
