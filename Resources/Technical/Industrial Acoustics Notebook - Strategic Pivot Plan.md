...
3. **Shop-Floor Tacit Knowledge Capture** (emerging frontier) - robust speech-in-noise transcription for shift handovers and voice-assisted logs; colloquial jargon translation into structured maintenance logs via [[LLM|LLMs]]; voice-activated "digital threading" integrated with [[MES]].
